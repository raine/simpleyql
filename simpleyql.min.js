 ...
 * Commit: 1c300b2
 * Date: Wed Jun 16 23:24:23 2010 +0300
 */
...
" and xpath='"+b.xpath+"'";b={q:a,diagnostics:"false",format:"json"};this.debug&&console.debug(b);b=e.toURI("http://query.yahooapis.com/v1/public/yql",b);jQuery.ajax({url:b,dataType:"jsonp",cache:"true",success:function(g){d(g.query.results)}})}}}();
