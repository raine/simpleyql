...
" and xpath='"+b.xpath+"'";b={q:a,diagnostics:"false",format:"json"};this.debug&&console.debug(b);b=e.toURI("http://query.yahooapis.com/v1/public/yql",b)+"&callback=?";jQuery.getJSON(b,function(g){d(g.query.results)})}}}();
